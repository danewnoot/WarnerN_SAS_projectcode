...
DATE: Thursday, January 08, 2015     TIME: 3:38:43 PM
PROJECT: WarnerN_SAS_project_01_13_15
PROJECT PATH: P:\QAC\qac200\students\nwarner\Assignments\WarnerN_SAS_project_01_13_15.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTNAME='WarnerN_SAS_project_01_13_15.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 3:37:52 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 3:37:53 PM
   By task: List Data
...
PROC SQL;
	CREATE VIEW WORK.SORTTempTableSorted AS
		SELECT T."DOWN/DEPR"n, T."CALM/PEACEFUL"n, T.ENERGY, T."HEALTH PROHIBITED SOC"n, T."PAIN LIMITS WORK"n, T."MNT PROBS WORK LIMIT"n, T."HLTH LIMITS MOD ACT"n, T."HLTH LIMITS STAIRS"n, T."GENERAL HLTH"n, T."ACCMP LESS BC PHY PROBS"n
		     , T."ACOMP LESS BS MNT PROBS"n, T."PHY PROBS LIMIT WORK"n
	FROM WORK.QUERY_FOR_NATVARRIABLES_MANAGED as T
;
QUIT;
TITLE;
...
PROC PRINT DATA=WORK.SORTTempTableSorted
	...
	LABEL
	;
	VAR "DOWN/DEPR"n "CALM/PEACEFUL"n ENERGY "HEALTH PROHIBITED SOC"n "PAIN LIMITS WORK"n "MNT PROBS WORK LIMIT"n "HLTH LIMITS MOD ACT"n "HLTH LIMITS STAIRS"n "GENERAL HLTH"n "ACCMP LESS BC PHY PROBS"n "ACOMP LESS BS MNT PROBS"n "PHY PROBS LIMIT WORK"n;
RUN;
/* -------------------------------------------------------------------
   End of task code.
   ------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 3:38:12 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 3:38:14 PM
